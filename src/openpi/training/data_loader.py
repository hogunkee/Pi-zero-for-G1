...
def create_torch_dataset(
    ...
    if repo_id == "multi":
        if data_config.dataset_path is None:
            raise ValueError("dataset_path must be set when using repo_id='multi'")
        single_datasets = []
        for p in data_config.dataset_path:
            ...
            dataset = lerobot_dataset.LeRobotSingleDataset(
                dataset_path=p,
        ...
        dataset = lerobot_dataset.LeRobotMixtureDataset(
            data_mixture=[
